                                ...
                                <div class="to">
                                    ...
                                    <div class="fundsTo">
                                       <svg version="1.1" class="svg-1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="43px" height="43px"
                                        ...
                                        <input name="sendTo" @focus="handleFocus" type="text" v-model="fundsTo" placeholder="Enter Recipient Address" selected="fundsTo"  class="sendTo" data-err=".send_to_error" />
                                    </div>
                                </div>
